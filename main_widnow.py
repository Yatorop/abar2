...
window = QWidget()
window.setStyleSheet("background:rgb(105,181,68);")
btn_menu = QPushButton('Меню')
btn_menu.setStyleSheet("background-color: purple;")
btn_rest = QPushButton('Відпочити')
btn_rest.setStyleSheet("background-color: purple;")
btn_next = QPushButton('Відповісти')
btn_next.setStyleSheet("background-color: purple;")

rb_ans1 = QRadioButton("1")
rb_ans1.setStyleSheet("background-color: red;")
rb_ans2 = QRadioButton("2")
rb_ans2.setStyleSheet("background-color: yellow;")
rb_ans3 = QRadioButton("3")
rb_ans3.setStyleSheet("background-color: green;")
rb_ans4 = QRadioButton("4")
rb_ans4.setStyleSheet("background-color: gray;")
...
lb_question.setStyleSheet("background-color: purple;")
...
gb_question.setStyleSheet("background-color: purple;")
rb_v1 = QVBoxLayout()
rb_v2 = QVBoxLayout()
rb_h1 = QHBoxLayout()
