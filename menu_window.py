...
lb_quest.setStyleSheet("background-color: yellow;")
lb_right_ans = QLabel('Введіть вірну відповідь:')
lb_right_ans.setStyleSheet("background-color: purple;")
lb_wrong_ans1 = QLabel('Введіть першу хибну відповідь')
lb_wrong_ans1.setStyleSheet("background-color: green;")
lb_wrong_ans2 = QLabel('Введіть другу хибну відповідь')
lb_wrong_ans2.setStyleSheet("background-color: pink;")
lb_wrong_ans3 = QLabel('Введіть третю хибну відповідь')
lb_wrong_ans3.setStyleSheet("background-color: purple;")
...
btn_back.setStyleSheet("background-color: yellow;")
btn_add_question = QPushButton('Додати запитання')
btn_add_question.setStyleSheet("background-color: green;")
btn_clear = QPushButton('Очистити')
btn_clear.setStyleSheet("background:rgb(0,0,255);")
